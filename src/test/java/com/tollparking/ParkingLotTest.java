...
public class ParkingLotTest {
	...
	public void setUp() throws Exception {
		parkingLot = new ParkingLot.Builder().addSlots(ParkingSlotType.SLOT_20KV, 6)
		...
		parkingSlotService = ParkingSlotService.getInstance();
	...
	public void testVehicleExit() throws ParkingFullException, InterruptedException {
		parkingSlotService.cleanSpecificParkingType(ParkingSlotType.SLOT_50KV);
